...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-surface text-surface-foreground flex flex-col gap-6 rounded-lg border border-border shadow-sm p-6",
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "leading-none text-lg font-semibold text-foreground",
        className,
      )}
      {...props}
    />
